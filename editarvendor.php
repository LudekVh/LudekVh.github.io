<?php 
    if (!isset($_GET ['id'])) {
    	header('Location: Vendedor.php.php');
    }

	include 'conexion.php';
    $id = $_GET ['id'];

    $sentencia = $bd->prepare("SELECT * FROM vendedor WHERE id = ?;");
 ...
 <body>
 	<center>
 		...
 		<form method="get" action="editarVendedor.php">
 			<table>
 				<tr>
 					<td>Nombre</td>
 				...
 				<tr>
 					...
 					<td colspan="2"><input type="submit" class="btn btn-primary" value="EDITAR VENDEDOR"></td>
 				</tr>
 			</table>
 		</form>
 	</center>
